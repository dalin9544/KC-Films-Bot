...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('👑 Contact Owner 👑', url=f'http://t.me/NJaNu_yir')
            ],
        [
    ...
    await query.answer('Mmmm.... എന്നിട്ട്...!!!', show_alert=True)
